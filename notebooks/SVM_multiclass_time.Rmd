...
SVM is applied to training set data and best parameters are chosen by cross validation. The best parameters are then applied to test set data to predict final classification result. 
...
# Change to above line to include your folder that contains data
set.seed(1)
